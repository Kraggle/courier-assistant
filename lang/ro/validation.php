...
return [
    ...
    */
    ...
    'between' => [
        ...
        'string' => 'Câmpul :attribute trebuie să aibă între caractere :min și :max.',
    ],
    ...
    'gt' => [
        ...
        'string' => 'Câmpul :attribute trebuie să fie mai mare decât caracterele :value.',
    ],
    'gte' => [
        ...
        'string' => 'Câmpul :attribute trebuie să fie mai mare sau egal cu caracterele :value.',
    ],
    ...
    'lt' => [
        ...
        'string' => 'Câmpul :attribute trebuie să aibă mai puțin de caractere :value.',
    ],
    'lte' => [
    ...
    'min' => [
        ...
        'string' => 'Câmpul :attribute trebuie să aibă cel puțin caractere :min.',
    ],
    ...
    'present_with_all' => 'Câmpul :attribute trebuie să fie prezent când sunt prezente :value.',
    ...
    'required_with_all' => 'Câmpul :attribute este obligatoriu când sunt prezente :value.',
    ...
    'size' => [
        'array' => 'Câmpul :attribute trebuie să conţină elemente :size.',
    ...
    */
    ...
    'values' => [
        'type' => [
            'fuel' => 'rata de combustibil',
            'md' => 'autoutilitară standard',
            'lg' => 'Mare de',
            'mfn-md' => 'Colecție standard',
            'mfn-lg' => 'Colecție mare',
            'poc' => 'birou',
        ]
    ]
];
