...
var dateDropperSetup = {
    languages: {
        en: {
            m: { s: ["Jan", "Feb", "Mar", "Apr", "May", "June", "July", "Aug", "Sept", "Oct", "Nov", "Dec"], f: ["January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"] },
            w: { s: ["S", "M", "T", "W", "T", "F", "S"], f: ["Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday"] },
        },
    },
};

const dateDropper = function() {
    ...
    (d.options = { format: "y-mm-dd", lang: "en", blocks: ["m", "d", "y"], autoFill: !0, jump: 10, loopAll: !0, loopDays: !0, loopMonths: !0, loopYears: !0, highlightWeekend: !0, defaultBehavior: !0, showArrowsOnHover: !0 }),
        w(d.options, arguments[0]),
        ...
        (d.getOptions = function(e) {
            ...
            ((t = w(t, d.dataOptions(e))),
                ...
                (t.defaultDate = p(t.defaultDate) || new Date()),
        ...
        (d.cleanOptions = function(e) {
            (e.date = d.fixDate(e, { input: e.options.defaultDate, fill: !0 })),
                ...
                e.options.rangeEnd &&
                d.valid(e, p(e.options.rangeStart)) &&
                d.valid(e, p(e.options.rangeEnd)) &&
                p(e.options.rangeEnd) >= p(e.options.rangeStart) &&
                ((e.options.range = !0), (e.range = { a: u(e.options.rangeStart), b: u(e.options.rangeEnd) }), (e.date = l(e.range.a)), (e.selected = new Date(c(e.date)))),
                e.options.range || (e.selected = new Date(c(e.date)));
        }),
        (d.lang = function(e) {
        ...
        (d.output = function(e, t) {
            ...
            return (
                (m.string = (t.format || e.options.format)
                    .replace(/\b(d)\b/g, m.d)
                    .replace(/\b(dd)\b/g, m.dd)
                    .replace(/\b(m)\b/g, m.m)
                    .replace(/\b(mm)\b/g, m.mm)
                    .replace(/\b(M)\b/g, m.M)
                    .replace(/\b(MM)\b/g, m.MM)
                    .replace(/\b(y)\b/g, m.y)
                    .replace(/\b(w)\b/g, m.w)
                    .replace(/\b(W)\b/g, m.W)
                    .replace(/\b(WW)\b/g, m.WW)
                    .replace(/\b(S)\b/g, m.S)
                    .replace(/\b(U)\b/g, m.U)),
                m
            );
        ...
        (d.block = function(e, t) {
            var o = h("div", { class: "dd__block", html: '<div class="dd__nav dd-left dd-hidden">' + d.svg("arrowLeft") + '</div><div class="dd__nav dd-right dd-hidden">' + d.svg("arrowRight") + '</div><div class="dd__view"></div>' });
        ...
        (d.calendarHeader = function(e) {
            for (var t = d.lang(e), o = h("div", { class: "dd__header" }), n = 0; n <= 6; n++) {
                var a = n,
                    r = h("div", { class: "dd__item" });
        ...
        (d.calendarDay = function(e, t) {
            var o = l(t.date),
                a = h("div", { html: '<div class="dd-value">' + t.date.d + "</div>", class: "dd__item " + (t.class || "") });
        ...
        (d.calendarBody = function(e, o) {
            ...
            if (6 != p) for (var u = p; u >= 0; u--) n.appendChild(d.calendarDay(e, { class: "dd-placeholder dd-before", date: { d: l.getDate() - u, m: l.getMonth() + 1, y: l.getFullYear() } })), c--;
            for (u = 1; u <= r; u++) n.appendChild(d.calendarDay(e, { class: "dd-i", date: { d: u, m: a.m, y: a.y } })), c--;
            for (u = 1; u <= c; u++) n.appendChild(d.calendarDay(e, { class: "dd-placeholder", date: { d: u, m: s.getMonth() + 1, y: s.getFullYear() } }));
            return n;
        }),
        ...
        (d.calendar = function(e) {
            ...
            if ((t.appendChild(d.createCalendar(e, { date: o })), d.isDoubleView(e))) {
                var n = l(o);
                n.setMonth(n.getMonth() + 1), (n = s(n)), t.appendChild(d.createCalendar(e, { date: n }));
            }
        }),
        ...
        (d.save = function(e, t) {
            e.options.range ? d.saveValues(e) : d.saveValue(e),
                e.options.onChange && e.options.onChange({ trigger: e.trigger, dropdown: e.dropdown, output: d.prepareOutput(e) }),
                t && e.options.onSubmit && e.options.onSubmit({ trigger: e.trigger, dropdown: e.dropdown, output: d.prepareOutput(e) });
        }),
        ...
        (d.valid = function(e, d) {
            ...
            t && !o && r && (t = !g({ date: d, arr: a(r) })), t && !r && o && (t = g({ date: d, arr: a(o) }));
        ...
        (d.move = function(e, t, o) {
            ...
            (n = d.fixDate(e, { input: n })), e.expanded || (e.selected = new Date(c(e.date))), d.change(e, !0);
        }),
        ...
        (d.monthDialogItem = function(e, t) {
            ...
            return d.dialogItem(e, {
                ...
                timeout: t.timeout,
                onClick: function() {
                    d.setDate(e, { m: t.value + 1 }, !0), d.change(e, !0), d.exitDialog(e, t.dialog);
                },
            });
        }),
        ...
        (d.yearDialog = function(e) {
            e.options.maxYear - e.options.minYear < 20 ||
                d.dialog(e, {
                    onDom: function(t) {
        ...
        (d.yearDialogItem = function(e, t) {
            return d.dialogItem(e, {
                ...
                onClick: function() {
                    t.init
                        ? ((t.dialog.innerHTML = ""), (t.dialog.scrollTop = 0), d.yearDialogLoop(e, { min: t.value, max: t.value + 10, dialog: t.dialog }))
                        : (d.setDate(e, { y: t.value }, !0), d.change(e, !0), d.exitDialog(e, t.dialog));
                },
            });
        }),
        ...
        (d.dialogItem = function(e, d) {
            var t = h("div", { class: d.class, html: d.html });
            return (
        ...
        (d.dialog = function(e, t) {
            var o = h("div", { class: "dd__dialog dd-hidden" });
            t.onDom && t.onDom(o);
            var n = h("div", { class: "dd__footer" });
        ...
        (d.dropdown = function(e) {
            if (
                ((e.dropdown = h("div", { class: "dd__dropdown dd-hidden " + (e.options.customClass || "") + (e.options.showArrowsOnHover ? " dd-arw-hover" : "") + (d.inline ? " dd-inline" : ""), id: "datedropper" })),
                    e.options.overlay && ((e.overlay = h("div", { class: "dd__overlay dd-hidden" })), document.body.appendChild(e.overlay)),
                    e.options.blocks.forEach(function(t) {
                        d.block(e, t);
                    }),
                    !d.inline)
            ) {
                var t = h("div", { class: "dd__footer" });
                e.dropdown.appendChild(t),
                    (e.primaryButton = h("div", { class: "dd__primaryButton", html: d.svg("checkmark") })),
            ...
            if (e.options.expandable) {
                if (!e.options.expandedOnly && !d.inline) {
                    var o = h("div", { class: "dd__expandButton", html: e.expanded ? d.svg("reduce") : d.svg("expand") });
                ...
                if (((e.expanded = !(void 0 !== e.expanded || !e.options.expandedDefault) || e.expanded), e.expanded)) {
                    ...
                    if (n) {
                        var a = h("div", { class: "dd__calendar" });
                        n.parentNode.insertBefore(a, n);
                    }
                }
            }
            d.inline ? ((e.trigger.innerHTML = ""), e.trigger.appendChild(e.dropdown)) : (e.trigger.classList.add("dd-focused"), document.body.appendChild(e.dropdown)),
