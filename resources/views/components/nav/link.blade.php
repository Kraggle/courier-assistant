...
<a {{ $attributes->merge(['class' => "$classes flex items-center gap-3 w-full pe-12 py-2 border-l-4 text-start text-base font-medium focus:outline-none transition duration-150 ease-in-out capitalize pl-[calc((100vw_-_80rem)_/_2)]"]) }}>
  <div class="w-2.5"></div>
  @if ($icon)
