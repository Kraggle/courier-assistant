...
<x-layout.app :title="$title">
  <x-section.one maxWidth="5xl">
    ...
    <div class="flex flex-col gap-2 text-sm sm:text-base">
      ...
      <h2 class="mt-4 font-serif text-base font-semibold sm:text-lg">Interpretation and Definitions</h2>
      <h3 class="font-serif font-medium">Interpretation</h3>
      <p>The words of which the initial letter is capitalized have meanings defined under the following conditions. The following definitions shall have the same meaning regardless of whether they appear in singular or in plural.</p>
      <h3 class="font-serif font-medium">Definitions</h3>
      ...
      <ul class="list-inside list-disc pl-2">
        ...
        <li>
          <strong>Website</strong> 'refers to Courier Assistant, accessible from <a href="https://courierasssistant.com"
      ...
      <h2 class="mt-4 font-serif text-base font-semibold sm:text-lg">Acknowledgment</h2>
      ...
      <h2 class="mt-4 font-serif text-base font-semibold sm:text-lg">Subscriptions</h2>
      <h3 class="font-serif font-medium">Subscription period</h3>
      ...
      <h3 class="font-serif font-medium">Subscription cancellations</h3>
      ...
      <h3 class="font-serif font-medium">Billing</h3>
      ...
      <h3 class="font-serif font-medium">Fee Changes</h3>
      ...
      <h3 class="font-serif font-medium">Refunds</h3>
      ...
      <h2 class="mt-4 font-serif text-base font-semibold sm:text-lg">User Accounts</h2>
      ...
      <h2 class="mt-4 font-serif text-base font-semibold sm:text-lg">Content</h2>
      <h3 class="font-serif font-medium">Your Right to Post Content</h3>
      ...
      <h3 class="font-serif font-medium">Content Restrictions</h3>
      ...
      <h3 class="font-serif font-medium">Content Backups</h3>
      ...
      <h2 class="mt-4 font-serif text-base font-semibold sm:text-lg">Copyright Policy</h2>
      <h3 class="font-serif font-medium">Intellectual Property Infringement</h3>
      ...
      <p>If You are a copyright owner, or authorized on behalf of one, and You believe that the copyrighted work has been copied in a way that constitutes copyright infringement that is taking place through the Service, You must submit Your notice in writing to the attention of our copyright agent via email at <a class="no-loader"
          href="mailto: info@courierasssistant.com">info@courierasssistant.com</a> and include in Your notice a detailed description of the alleged infringement.</p>
      ...
      <h3 class="font-serif font-medium">DMCA Notice and DMCA Procedure for Copyright Infringement Claims</h3>
      ...
      <p>You can contact our copyright agent via email at <a class="no-loader"
          href="mailto: info@courierasssistant.com">info@courierasssistant.com</a>.
      ...
      <h2 class="mt-4 font-serif text-base font-semibold sm:text-lg">Your Feedback to Us</h2>
      ...
      <h2 class="mt-4 font-serif text-base font-semibold sm:text-lg">Links to Other Websites</h2>
      ...
      <h2 class="mt-4 font-serif text-base font-semibold sm:text-lg">Termination</h2>
      <p>We may terminate or suspend Your Account immediately, without prior notice or liability, for any reason whatsoever, including without limitation if You breach these Terms and Conditions.</p>
      <p>Upon termination, Your right to use the Service will cease immediately. If You wish to terminate Your Account, You may simply discontinue using the Service.</p>
      <h2 class="mt-4 font-serif text-base font-semibold sm:text-lg">Limitation of Liability</h2>
      ...
      <h2 class="mt-4 font-serif text-base font-semibold sm:text-lg">"AS IS" and "AS AVAILABLE" Disclaimer</h2>
      ...
      <h2 class="mt-4 font-serif text-base font-semibold sm:text-lg">Governing Law</h2>
      <p>The laws of the Country, excluding its conflicts of law rules, shall govern this Terms and Your use of the Service. Your use of the Application may also be subject to other local, state, national, or international laws.</p>
      <h2 class="mt-4 font-serif text-base font-semibold sm:text-lg">Disputes Resolution</h2>
      <p>If You have any concern or dispute about the Service, You agree to first try to resolve the dispute informally by contacting the Company.</p>
      <h2 class="mt-4 font-serif text-base font-semibold sm:text-lg">For European Union (EU) Users</h2>
      <p>If You are a European Union consumer, you will benefit from any mandatory provisions of the law of the country in which You are resident.</p>
      <h2 class="mt-4 font-serif text-base font-semibold sm:text-lg">United States Federal Government End Use Provisions</h2>
      ...
      <h2 class="mt-4 font-serif text-base font-semibold sm:text-lg">United States Legal Compliance</h2>
      <p>You represent and warrant that (i) You are not located in a country that is subject to the United States government embargo, or that has been designated by the United States government as a "terrorist supporting" country, and (ii) You are not listed on any United States government list of prohibited or restricted parties.</p>
      <h2 class="mt-4 font-serif text-base font-semibold sm:text-lg">Severability and Waiver</h2>
      <h3 class="font-serif font-medium">Severability</h3>
      <p>If any provision of these Terms is held to be unenforceable or invalid, such provision will be changed and interpreted to accomplish the objectives of such provision to the greatest extent possible under applicable law and the remaining provisions will continue in full force and effect.</p>
      <h3 class="font-serif font-medium">Waiver</h3>
      <p>Except as provided herein, the failure to exercise a right or to require performance of an obligation under these Terms shall not affect a party's ability to exercise such right or require such performance at any time thereafter nor shall the waiver of a breach constitute a waiver of any subsequent breach.</p>
      <h2 class="mt-4 font-serif text-base font-semibold sm:text-lg">Translation Interpretation</h2>
      <p>These Terms and Conditions may have been translated if We have made them available to You on our Service.
        You agree that the original English text shall prevail in the case of a dispute.</p>
      <h2 class="mt-4 font-serif text-base font-semibold sm:text-lg">Changes to These Terms and Conditions</h2>
      <p>We reserve the right, at Our sole discretion, to modify or replace these Terms at any time. If a revision is material We will make reasonable efforts to provide at least 30 days' notice prior to any new terms taking effect. What constitutes a material change will be determined at Our sole discretion.</p>
      <p>By continuing to access or use Our Service after those revisions become effective, You agree to be bound by the revised terms. If You do not agree to the new terms, in whole or in part, please stop using the website and the Service.</p>
      <h2 class="mt-4 font-serif text-base font-semibold sm:text-lg">Contact Us</h2>
      <p>If you have any questions about these Terms and Conditions, You can contact us:</p>
      <ul class="list-inside list-disc pl-2">
        <li>By email: <a class="no-loader"
            href="mailto: info@courierasssistant.com">info@courierasssistant.com</a></li>
      </ul>
